---
date: 2020-10-24
title: Converting Images to Ascii Art
author: Shocking2
excerpt: Suddenly I had a yearning to turn photos into Ascii Art and wanted a script to do it for me
...
font = ImageFont.truetype(
    "/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf", fontsize, encoding="unic"
)
...
def create_ascii_video_2():
    ...
    while rval:
        ...
        try:
            ...
            print(
                "cannot identify image while loop in function create_ascii_video_2",
                myimage,
            )
        continue
        ...
        img = Image.new(
            "RGBA", (new_img_width, how_many_rows * fontsize)
        )
...
def create_ascii_image():
    ...
    img = Image.new("RGBA", (new_img_width, how_many_rows * fontsize))
    draw = ImageDraw.Draw(img)
...
def calculate_image_size_from_video():
    ...
    if vc.isOpened():
        ...
        print(
            "In fucntion calculate_image_size_from_video I could not find the video frame size."
        )
